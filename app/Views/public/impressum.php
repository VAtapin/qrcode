...
$representedBy = trim((string) setting('legal.represented_by', ''));
$contentResponsible = trim((string) setting('legal.content_responsible', $provider));
...
<section class="panel narrow">
    ...
    <dl class="impressum-list">
        ...
        <?php if ($representedBy !== ''): ?>
            <div>
                <dt><?= e(__('legal.represented_by')) ?></dt>
                <dd><?= e($representedBy) ?></dd>
            </div>
        <?php endif; ?>
    </dl>

    <?php if ($contentResponsible !== ''): ?>
        <h2><?= e(__('legal.content_responsible')) ?></h2>
        <p><?= nl2br(e($contentResponsible)) ?></p>
    <?php endif; ?>
