...
- Footer с авторством Bible Media Agentur, публичные страницы `/impressum` и `/datenschutz`.
...
Перед публикацией замените `BITTE ANSCHRIFT ERGÄNZEN` на полную ladungsfähige Anschrift владельца сайта.
Страницу Datenschutz также нужно проверить и дополнить данными хостинга, сроками хранения и внешними сервисами, если они используются.
